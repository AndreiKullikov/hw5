    ...
    def run(self) -> None:
        ...
        while getNewIter:
            ...
            if com == Command.EXIT:
                ...
                self.view.printAllStudent(self.model.getStudents())
            elif com == Command.LISTENG:
                self.view.printAllStudentEng(self.model.getStudents())
            elif com == Command.DELETE:
                student_id = self.view.promptForStudentId()
                self.model.removeStudent(student_id)
